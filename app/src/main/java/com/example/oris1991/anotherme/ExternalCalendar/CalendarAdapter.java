...
public class CalendarAdapter extends BaseAdapter {
	...
	public GregorianCalendar pmonth; // main_content instance for previous month
	/**
	 * main_content instance for previous month for getting complete view
	 */
	...
	public void refreshDays() {
		...
		calMaxP = maxP - (firstDay - 1);// main_content offday starting 24,25 ...
		/**
